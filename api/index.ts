...
import { OrderRepository, connectDB } from "../src/lib/store.js"; // Note: .js might be needed or TypeScript handles it
...
// IMPORTANT: Do NOT call app.listen() here! Export it for Vercel.
export default app;
